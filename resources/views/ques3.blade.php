    ...
    <div class="row-cols-1">
      <div class="formHolder">
        ...
        <div class="formBody">
          ...
          <ul class="btnBox">
            <li><a href="javascript:void(0)" class="btn btn-success" id="a-Before2002"><img src="img/Not-selected.png" alt="btn">Before 2002</a></li>
            <li><a href="javascript:void(0)" class="btn btn-success" id="a-2002-2022"><img src="img/Not-selected.png" alt="btn">2002 - 2022</a></li>
          </ul>
